...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'forbiddennebula.data';
    var REMOTE_PACKAGE_BASE = 'forbiddennebula.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 11331169;
      var PACKAGE_UUID = 'f314c072-23ad-41ba-8633-b817afcf2838';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 8506888, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(8506888, 8507322, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(8507322, 8512272, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(8512272, 10428572, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(10428572, 11303544, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(11303544, 11331169, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_forbiddennebula.data');

    };
    Module['addRunDependency']('datafile_forbiddennebula.data');
